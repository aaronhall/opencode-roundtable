...
**Zero dependencies, zero compiled code, zero plugins.** The entire system is markdown files + the `/roundtable-init` command that generates persona agent files from definitions.
